//
//  AsyncSequenceSinkDetachedSyncVoidTests.swift
...
final class AsyncSequenceSinkDetachedSyncVoidTests: XCTestCase {
    ...
    // MARK: - sink - sync - Void - failure (with default implementation)
...
extension AsyncSequenceSinkDetachedSyncVoidTests: @unchecked Sendable {}
