//
//  AsyncSequenceSinkDetachedAsyncControlContinueTests.swift
...
final class AsyncSequenceSinkDetachedAsyncControlContinueTests: XCTestCase {
    ...
    // MARK: - sink - async - Control - continue - success
    ...
    // MARK: - sink - async - Control - continue - success and failure
    ...
    // MARK: - sink - async - Control - continue - failure and success
    ...
    // MARK: - sink - async - Control - continue - failure
    ...
    // MARK: - sink - async - Control - continue - failure (with default implementation)
...
extension AsyncSequenceSinkDetachedAsyncControlContinueTests: @unchecked Sendable {}
