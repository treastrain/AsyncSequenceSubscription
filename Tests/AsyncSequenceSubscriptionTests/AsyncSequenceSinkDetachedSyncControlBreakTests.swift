//
//  AsyncSequenceSinkDetachedSyncControlBreakTests.swift
...
final class AsyncSequenceSinkDetachedSyncControlBreakTests: XCTestCase {
    ...
    // MARK: - sink - sync - Control - break - success
    ...
    // MARK: - sink - sync - Control - break - success and failure
    ...
    // MARK: - sink - sync - Control - break - failure and success
    ...
    // MARK: - sink - sync - Control - break - failure
    ...
    // MARK: - sink - sync - Control - break - failure (with default implementation)
...
extension AsyncSequenceSinkDetachedSyncControlBreakTests: @unchecked Sendable {}
